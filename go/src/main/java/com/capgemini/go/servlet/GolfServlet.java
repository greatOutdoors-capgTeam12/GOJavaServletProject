 ...
 */
@WebServlet("/GolfServlet")
public class GolfServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6722253651487598175L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (userId.equalsIgnoreCase("ALL")) {
				...
				reports = go.viewSalesReportByCategory(dentry, dexit, 2);
				out.println(
				...
				ViewSalesReportByUserDTO report = go.viewSalesReportByUserAndCategory(dentry, dexit, userId, 2).get(0);
