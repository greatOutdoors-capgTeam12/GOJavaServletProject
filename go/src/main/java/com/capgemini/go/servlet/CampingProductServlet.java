...
/**
 * Servlet implementation class CampingProductServlet
 */
public class CampingProductServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		ProductFilterDTO filterProduct= new ProductFilterDTO("","", 0, 1000000, 1, "");
