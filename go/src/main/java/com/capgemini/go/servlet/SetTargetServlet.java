 ...
 */
@WebServlet("/SetTargetServlet")
public class SetTargetServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7596972078445435110L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			go.setTarget(sr, target);
			out.println("<br>Target of " + userId + " is updated. </br>");
