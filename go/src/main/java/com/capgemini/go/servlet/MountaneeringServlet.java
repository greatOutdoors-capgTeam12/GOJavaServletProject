 ...
 */
@WebServlet("/MountaneeringServlet")
public class MountaneeringServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1989775831983279613L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (userId.equalsIgnoreCase("ALL")) {
				...
				reports = go.viewSalesReportByCategory(dentry, dexit, 3);
				out.println(
						"<body><table><tr><td>User ID</td><td>Date</td><td>Order ID</td><td>Product Category</td><td>Product ID</td><td>Product Price</td></tr>");
				...
				ViewSalesReportByUserDTO report = go.viewSalesReportByUserAndCategory(dentry, dexit, userId, 3).get(0);
				out.println(
						"<body><table><tr><td>User ID</td><td>Date</td><td>Order ID</td><td>Product Category</td><td>Product ID</td><td>Product Price</td></tr>");
