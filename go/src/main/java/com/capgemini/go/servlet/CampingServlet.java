...
public class CampingServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2493756180136496303L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (userId.equalsIgnoreCase("ALL")) {
				...
				reports = go.viewSalesReportByCategory(dentry, dexit, 1);
				...
				ViewSalesReportByUserDTO report = go.viewSalesReportByUserAndCategory(dentry, dexit, userId, 1).get(0);
				out.println(
						"<body><table><tr><td>User ID</td><td>Date</td><td>Order ID</td><td>Product Category</td><td>Product ID</td><td>Product Price</td></tr>");
