					...
					while (RetailerEntry == true) {
						...
						case 2:
							try {
								...
								FrequentOrderedDTO freqOrder = new FrequentOrderedDTO(retailerID, productID, null);
						...
						case 3:
							try {
								...
								FrequentOrderedDTO freqOrder = new FrequentOrderedDTO(retailerID, productID, addressID);
								retailerservice.changeProductAddress(freqOrder);
