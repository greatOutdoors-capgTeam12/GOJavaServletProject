...
public class DeleteAddressTester {
		...
		@Given("^User clicks the Delete Address button$")
		...
		@When("^User enters the addressId as \"(.*)\"$")
		public void It_enters_required_details(String arg1) {
			
			System.out.println("address_Id="+ arg1);
			
			driver.findElement(By.id("deleteaddress_ID")).sendKeys(arg1);
		}

		@When("^User clicks on Submit Button$")
		public void It_clicks_submit_button() {
			driver.findElement(By.name("deleteAddressSubmit")).click();
		}
