...
public class UpdateAddressServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String building_num = request.getParameter("updatebuilding_num");
		...
		String ret_id = request.getParameter("updateretailerId");
		String address_ID = request.getParameter("updateaddress_ID");
		try {
