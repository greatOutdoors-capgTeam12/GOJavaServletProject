...
public class CheckTargetStatus {
	...
	public void clicks_the_check_bonus_button() throws InterruptedException {
		...
		driver.findElement(By.name("checkTargetStatus")).click();
		Thread.sleep(500);
	}
	...
	public void It_enters_the_UserId_as(String arg1) throws InterruptedException {
		...
		driver.findElement(By.name("UserIdCheckTargetStatus")).sendKeys(arg1);
		Thread.sleep(1000);
	}

	@When("^It clicks submit button$")
	public void It_clicks_submit_button() throws InterruptedException {
		driver.findElement(By.id("submitCheckTargetStatus")).submit();
		Thread.sleep(5000);
	}
