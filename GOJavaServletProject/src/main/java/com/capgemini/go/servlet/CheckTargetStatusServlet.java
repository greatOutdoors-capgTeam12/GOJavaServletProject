...
@WebServlet("/CheckTargetStatusServlet")
public class CheckTargetStatusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	SalesRepresentativeService salesRepService = new SalesRepresentativeServiceImpl();
	String message = null;

    public CheckTargetStatusServlet() {
        super();
    }
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String userId = request.getParameter("UserIdCheckTargetStatus");
		try {
			message = salesRepService.checkTargetSales(userId);
