 ...
 */
@WebServlet("/OutdoorServlet")
public class OutdoorServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2051883640190956447L;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (userId.equalsIgnoreCase("ALL")) {
				...
				reports = go.viewSalesReportByCategory(dentry, dexit, 5);
				out.println(
				...
				ViewSalesReportByUserDTO report = go.viewSalesReportByUserAndCategory(dentry, dexit, userId, 5).get(0);
				out.println(
						"<body><table><tr><td>User ID</td><td>Date</td><td>Order ID</td><td>Product Category</td><td>Product ID</td><td>Product Price</td></tr>");
