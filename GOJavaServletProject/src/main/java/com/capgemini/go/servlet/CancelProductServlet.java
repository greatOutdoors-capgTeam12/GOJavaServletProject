...
public class CancelProductServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Inside Cancel Product Servlet");
	    ...
	    String productId = myMap.get("productId");
	    int quantity = Integer.parseInt(myMap.get("quantity"));
		System.out.println("Here : "+userId+" "+orderId+" "+productId+" "+quantity);
		...
		try {
			message = salesRepService.cancelProduct(orderId, userId, productId, quantity);
