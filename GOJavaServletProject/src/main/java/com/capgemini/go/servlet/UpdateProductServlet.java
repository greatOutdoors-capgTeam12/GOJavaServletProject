...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ProductDTO upProd  = new ProductDTO(productId, price, colour, dimension, specification, manufacturer, quantity, productCategory, productName);
		...
		PrintWriter out =response.getWriter();
			...
			try {
				result = prodMast.updateProduct(upProd);
				result = prodMast.addExistingProduct(upProd);
				if(result)
				{
					((ObjectNode) dataResponse).put("Success :","Product Updated Successfully");
				}
